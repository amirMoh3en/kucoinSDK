...
public class KucoinPrivateWSClientImpl extends BaseWebsocketImpl implements KucoinPrivateWSClient {
    ...
    public KucoinPrivateWSClientImpl(KucoinClientBuilder kucoinClientBuilder, KucoinPrivateWebsocketListener kucoinPrivateWebsocketListener, OkHttpClient okHttpClient) {
        this(
                okHttpClient,
