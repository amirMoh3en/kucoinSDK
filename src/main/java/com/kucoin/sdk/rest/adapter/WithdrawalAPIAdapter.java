...
public class WithdrawalAPIAdapter extends AuthRetrofitAPIImpl<WithdrawalAPIRetrofit> implements WithdrawalAPI {
    ...
    @Override
    public Pagination<WithdrawResponse> getWithdrawList(int currentPage, int pageSize) throws IOException {
        return super.executeSync(getAPIImpl().getWithdrawPageList(currentPage, pageSize));
    }
}
